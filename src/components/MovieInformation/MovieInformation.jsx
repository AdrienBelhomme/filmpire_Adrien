...
import { useGetMovieQuery, useGetRecommandationsQuery } from '../../services/TMDB';
...
const MovieInformation = () => {
  ...
  const { id } = useParams();
  const { data: recommendations, isFetching: isRecommendationsFetching } = useGetRecommandationsQuery({ list: '/recommendations', movie_id: id });
